...
Router.map(function () {
	...
	this.route("users.insert", {path: "/users/insert", controller: "UsersInsertController"});
	this.route("users.details", {path: "/users/details/:customerId", controller: "UsersDetailsController"});
	this.route("users.edit", {path: "/users/edit/:customerId", controller: "UsersEditController"});
	...
	this.route("products.details", {path: "/products/details/:customerId", controller: "ProductsDetailsController"});
	this.route("products.edit", {path: "/products/edit/:customerId", controller: "ProductsEditController"});
});
